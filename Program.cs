...
string MSG_FirstStart = $@"Welcome to Practice the Basics. 
This is a console app that shows of demonstrations of understanding some of the basics.";

string MSG_Statement = $@"I really wanted to make this to learn how to program in C#.
For the longest time I would just get by on fundemantals but never really dove deep into practical applications.
Recently I left a project because there was a contract dispute. 
The thing that held me back was the lack of understanding how to build complex systems and discipline.
I want to learn to make games the right way without relying on if a package will be updated or not. 
When I want to make something, I want to be able to at least get to a working prototype before giving up.

I want to make this so that when my son is older, we can make cool games together and he can make his own video games.
...
Console.WriteLine(MSG_BorderDash + "\n");
Console.WriteLine(MSG_MenuOptions);
Console.WriteLine(MSG_BorderDash);
Console.WriteLine("\n\n\n\n");
//
